...
const Content = ({
  ...
  const waitForNonce = () => {
    return new Promise((resolve, reject) => {
      const timeout = 10000; // Max wait time: 10 seconds
  ...
  try {
    const square_nonce = await waitForNonce();
...
const woosquarePaymentMethod = {
  ...
  savedTokenComponent: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Content, {
    RenderedComponent: SquareSavedCard
  }),
  canMakePayment: () => true,
